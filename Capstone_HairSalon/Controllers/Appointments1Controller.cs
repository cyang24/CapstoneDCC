...
namespace Capstone_HairSalon.Controllers
{
    public class Appointments1Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,PhoneNumber,Time,CreatedAt")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,PhoneNumber,Time,CreatedAt")] Appointment appointment)
        {
            if (ModelState.IsValid)
            {
